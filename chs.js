...
var cnItems = {
    ...
    'Bubba': '布巴',
    'Crossbow': '弩',
    'Contains 1 random Tier 2 card. There are 17 card possibilities in Tier 2.': '包含1张随机2级卡。 第2层可能有17种卡。',
    'Contains a random Tier 1 card. There are 28 card possibilities in Tier 1.': '包含1张随机的1级卡片。 第1层可能有28种卡。',
    'held (min +1/sec, max +30/sec': 'held（最小+ 1 /秒，最大+ 30 /秒',
    'Forest Inn': '森林旅馆',
    'Gargoyle': '石像鬼',
    'Gauntlet': '护手',
    'Hades': '地狱',
...
var cnRegReplace = new Map([
    ...
    [/^Contains (.+) random Tier (.+) cards. There are (.+) card possibilities in Tier (.+).$/, '包含$1张随机第$2层卡。 第$4层可能有$3种卡。'],
