...
var cnItems = {
    ...
    '   Drops': '掉落',
    'complete, please wait...': '完成，请稍候...',
    'production for cards above and below': '上下方卡牌的产量',
    'Barracks': '军营',
    'Desert': '沙漠',
    'You have mastered this arena and received all of its ascension gems.': '您已经掌握了此竞技场并获得了其所有提升宝石。',
    '': '',
    '': '',
    '': '',
    '': '',
...
var cnRegReplace = new Map([
    [/^(\d+)-star odds increase$/, '$1-星几率增加'],
    [/^Slightly increases the odds of (\d+)-star cards dropping. Can be toggled on\/off.$/, '稍微增加 $1-星 卡掉落的几率。 可以打开/关闭。'],
    [/^(\d+) seconds$/, '$1 秒'],
    ...
    [/^Contains a random Tier (.+) card. There are (.+) card possibilities in Tier (.+).$/, '包含1张随机 T$1卡。 T$3 有$2种卡。'],
